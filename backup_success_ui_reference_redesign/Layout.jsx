  ...
  return (
    <div className="app-shell">
      <header className="top-nav">
        <div className="mx-auto flex max-w-[1360px] items-stretch justify-between gap-4 px-4">
          <button className="brand-button py-2" onClick={() => onNavigate('home')}>
          ...
          <nav className="hidden flex-1 items-stretch justify-center gap-0 lg:flex">
            {navItems.map((item) => {
          ...
          <button className="account-button flex items-center self-center" onClick={openProfile}>
