import { Activity, BarChart3, CheckCircle2, Download, Sparkles } from 'lucide-react'
  ...
  return (
    <Panel>
      ...
      <div className="mt-4 grid gap-3">
        {data.map((item) => (
          <div key={item.label}>
            <div className="mb-1 flex justify-between gap-3 text-sm text-slate-200">
...
export function DataTable({ headers, rows, minWidth = 840 }) {
  return (
